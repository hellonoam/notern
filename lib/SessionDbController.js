 ...
 */
SessionDbController.protoype.addSession(username, session, callback) {
 ...
 */
SessionDbController.prototype.checkValid(username, session, callback) {
    this.db.executeGuarded(
 ...
 */
SessionDbController.prototype.removeSession(username, session, callback) {
    this.db.executeGuarded(
